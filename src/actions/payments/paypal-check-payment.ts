...
export const paypalCheckPayment = async (paypalTransactionId: string) => {
  console.log('llegaaaaa acualizar el pago #####################################0')
  ...
  console.log('llegaaaaa acualizar el pago #####################################1')
  ...
  console.log('llegaaaaa acualizar el pago #####################################2')
  ...
  try {
    console.log('llegaaaaa acualizar el pago #####################################3')
    ...
    console.log('llegaaaaa acualizar el pago #####################################4')
